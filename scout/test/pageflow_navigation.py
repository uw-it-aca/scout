...
class PageflowNavigationTest(LiveServerTestCase):
    ...
    def assertLocation(self, loc):
        """Checks to see if the current url matches the given intended URL"""
        currentLoc = self.driver.current_url
        expectedLoc = self.baseurl + loc
        self.assertEqual(currentLoc, expectedLoc)
    ...
    # @unittest.expectedFailure uncomment for debugging
