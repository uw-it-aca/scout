...
_testCases = (
    ...
    (
        "Food Filter Coffee",
        baseUrl + "/food/?food0=s_food_espresso",
        OK,
        "SCOUT-77",
    ),
    (
        "Food Filter Breakfast",
        baseUrl + "/food/?period0=morning",
        OK,
        "SCOUT-79",
    ),
    (
        "Food Filter Latenight",
        baseUrl + "/food/?period0=late_night",
        OK,
        "SCOUT-78",
    ),
