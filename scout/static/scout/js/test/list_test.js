...
describe('List Tests', function() {
    describe('Order Spot List', function() {
        it('should sort spots that need to be sorted', function() {
        ...
        it('should not do anything to an empty list of spots', function() {
            // Need to wrap our actual list in an element so we can grab
            // the HTML easily
            var init_list = '<ol id="scout_list"></ol>';
            var $ = tools.jqueryFromHtml(init_list);
            global.$ = $;
            // Do the sorting
            List.order_spot_list();
